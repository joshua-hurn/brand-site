...
const Footer = () => {
  return (
    <footer className={styles.footer}>
      <Link href={"https://github.com/joshua-hurn"} aria-label="Github" className={styles.logoLink}>
        <img src={"/assets/images/github-square.svg"} alt="github logo that links to my github profile" width={30} height={60} />
      </Link>

      <Link href={"https://www.linkedin.com/in/josh-hurn/"} aria-label="LinkedIn" className={styles.logoLink}>
